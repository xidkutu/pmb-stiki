		...
		<div class="portlet light">
			...
			<div class="portlet-body">                
				<div class="table-container">
					<table id="data_bayar_daftar" class="table table-responsive table-striped table-bordered table-hover ">
							<thead>
                                <tr>    
								...
								<tr>
									...
									<th class="sort-alpha">Nominal</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        /* i Datatables */        
        var datatable;
        datatable = $('#data_bayar_daftar').DataTable({
