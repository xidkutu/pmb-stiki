		...
		<div class="portlet light">
			...
			<div class="portlet-body">
				<div class="table-container">
					<table id="datatable_data_mhs_diterima" class="table table-responsive table-striped table-bordered table-hover ">
							<thead>
								<tr>
                                    <th class="sort-alpha">Tgl Diterima</th>
                                    ...
                                    <th class="sort-alpha">Diterima</th>
                                    <th class="sort-alpha">Status Masuk</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        /* i Datatables */        
        var datatable;
        datatable = $('#datatable_data_mhs_diterima').DataTable({
		...
		$('.dataTables_wrapper').css({'margin-top' : '-65px'});
        $('.dataTables_length').parents('.row').css({'margin-top':'10px'});
