                    ...
                    <div class="col-md-6 col-sm-12">
            			<div class="portlet light ">
                			<div class="portlet-title">
                				<div class="caption caption-md">
                					...
                					<span class="caption-subject theme-font-color bold uppercase">Tabel Usulan Jalur Penerimaan</span>
                        ...
                        <div class="portlet light ">
                			<div class="portlet-title">
                				<div class="caption caption-md">
                					<i class="icon-bar-chart theme-font-color hide"></i>
                					<span class="caption-subject theme-font-color bold uppercase">Tabel Pemberian Jalur Penerimaan</span>
                					<span class="caption-helper hide">weekly stats...</span>
                				</div>
                				<div class="actions">
                                <a class="btn btn-circle btn-icon-only btn-default export-excel" href="#" target-table="my_tabel_beri">
									<i class="fa fa-file-excel-o"></i>
                                </a>
                                <a class="btn btn-circle btn-icon-only btn-default tutup" href="#">
									<i class="icon-tutup fa fa-chevron-down"></i>
                			...
                			<div class="portlet-body" id="body-tabel-beri">
                                <table class="table">
                                    <tr><td colspan="3" style="text-align: center;">Tidak ada data</td></tr>
                                </table>
                			</div>
                    ...
                    <div class="col-md-6 col-sm-12">
            			<div class="portlet light ">
                			<div class="portlet-title">
                				<div class="caption caption-md">
                					<i class="icon-bar-chart theme-font-color hide"></i>
                					<span class="caption-subject theme-font-color bold uppercase">Diagram Pie Usulan Jalur Penerimaan</span>
                					<span class="caption-helper hide">weekly stats...</span>
                				</div>
                				<div class="actions">
                                <a class="btn btn-circle btn-icon-only btn-default tutup" href="#">
                        ...
                        <div class="portlet light ">
                			<div class="portlet-title">
                				<div class="caption caption-md">
                					<i class="icon-bar-chart theme-font-color hide"></i>
                					<span class="caption-subject theme-font-color bold uppercase">Diagram Pie Pemberian Jalur Penerimaan</span>
                					<span class="caption-helper hide">weekly stats...</span>
                				</div>
                				<div class="actions">
                                <a class="btn btn-circle btn-icon-only btn-default tutup" href="#">
...
function getReportBeri(){
    var tipe=$("#filtr_tipe").val();
    if(tipe.length>0 && !jQuery.isEmptyObject(dateStart) && !jQuery.isEmptyObject(dateEnd)){
        Metronic.startPageLoading({animate: true});
        $.post( "<?php echo base_url();?>index.php/<?php echo $page_id?>/getReportBeri",{tipe:tipe,start:dateStart.format('YYYY-MM-DD'),end:dateEnd.format('YYYY-MM-DD')}, function( data ) {
           //ChartsAmcharts.init(data);
           $("#body-tabel-beri").html(data);
           getReportBeri_pie();
           Metronic.stopPageLoading();
        });    
    }
}
function getReportBeri_pie(){
    var tipe=$("#filtr_tipe").val();
    if(tipe.length>0 && !jQuery.isEmptyObject(dateStart) && !jQuery.isEmptyObject(dateEnd)){
        Metronic.startPageLoading({animate: true});
        $.post( "<?php echo base_url();?>index.php/<?php echo $page_id?>/getReportBeri_pie",{tipe:tipe,start:dateStart.format('YYYY-MM-DD'),end:dateEnd.format('YYYY-MM-DD')}, function( data ) {
