		...
		<div class="portlet light">
			...
			<div class="portlet-body table-both-scroll">
				<div class="table-container" style="overflow-x: scroll;">
					<table id="data_<?php echo $page_id;?>" class="table table-striped table-bordered table-hover order-column">
							<thead>								                           
								<tr>
									<th class="sort-alpha">Tanggal</th>
                                    <th class="sort-alpha">NRP</th>
                                    <th class="sort-alpha">Nama</th>
                                    <th class="sort-alpha">Sekolah</th>
                                    <th class="sort-alpha">Kota Sklh</th>
                                    <th class="sort-alpha">Prop.Sklh</th>
                                    <th class="sort-alpha">Ukuran Baju</th>
                                    <th class="sort-alpha">Agama</th>
                                    <th class="sort-alpha">Telp</th>
                                    <th class="sort-alpha">Asal Info</th>
                                    <th class="sort-alpha">Jenjang</th>
                                    <th class="sort-alpha">Program Studi</th>
                                    <th class="sort-alpha">Kelas</th>
                                    <th class="sort-alpha">Jenis Masuk</th>
                                    <th class="sort-alpha">Jalur</th>
                                    <th class="sort-alpha">Daftar Ulang</th>                                    
								</tr>
							</thead>
							<tbody>
							</tbody>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        datatable = $('#data_<?php echo $page_id;?>').DataTable({
			...
			"serverSide": true,            
			"ajax":{
                 'url' :'<?php echo base_url()?>index.php/<?php echo $page_id?>/retrieveData',
				"data": function ( d ) {
					d.tglmulai = tglmulai;
					d.tglsmp = tglsmp;
				}
