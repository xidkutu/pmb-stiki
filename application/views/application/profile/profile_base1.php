...
<div class="row">
	<div class="col-md-12">
		...
		<div class="profile-sidebar pull-right not-printable" style="width: 250px;">
			<!-- PORTLET MAIN -->
...
$(document).ready(function(){
    ...
    $('#avatarModal').imgPicker({
				url: '<?php echo base_url()?>tr_pmb_insert_data/uploadavatar',
				aspectRatio: 0.75,
				deleteComplete: function() {
					$('#img_profile').attr('src', '<?php echo base_url()?>assets/admin/layout4/img/avatar.png');
					this.modal('hide');
				},
