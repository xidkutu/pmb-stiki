...
<div class="row">
	<div class="col-md-12">
        ...
        <?php if(!$isCookieEnabled){?>
            <div class="alert alert-danger">
				<strong>Oh Snap!</strong> Fitur ini menggunakan cookie untuk dapat berfungsi dengan baik. Sistem mendeteksi cookie pada browser ini tidak aktif. Aktifkan cookie atau hubungi administrator untuk dapat menggunakan fitur ini.
			</div>
        <?php }?>
