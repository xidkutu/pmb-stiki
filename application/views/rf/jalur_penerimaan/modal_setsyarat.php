  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="<?php echo $page_id;?>_modal_input_title" >Jalur Penerimaan</h4>
      </div>
      <div class="modal-body">
        <div class="portlet box green-haze">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa <?php echo $page_info['Icon']?>"></i>Tetapkan Syarat
				</div>
				<div class="tools">
							...
							<div class="panel-body">
								<form action="" class="frm_validation form-horizontal row-border" id="frm_validation2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <label class="control-label" id="det_Nama_JalurPenerimaan">Beasiswa Penuh</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Syarat</label>
                                        <div class="col-sm-6">
                                            <select class="form-control" id="form_syarat_syarat" required="required">
                                            </select>
                                        </div>
                                        <input type="hidden" name="form_syarat_id_jalur" id="form_syarat_id_jalur" value=""/>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                        </div>
...
<script type="text/javascript">
    function <?php echo $page_id;?>_btnSyaratSaveClick(){
        if(validation('frm_validation2')==true){
    		var id_jalur=$("#form_syarat_id_jalur").val();
    		var syarat = $("#form_syarat_syarat").val();
              		
    		var string = "id_jalur="+id_jalur+"&syarat="+syarat;
  
    		$.ajax({
    			type	: 'POST',
    			url		: "<?php echo base_url(); ?>index.php/rf_pmb_jalur_penerimaan/saveSyarat",
    			data	: string,
    			cache	: false,
    ...
    function resetFormDetail(){
        $("#form_syarat_syarat").val('');
    }
    
    function setHapusDataDetail(idSyarat){
        bootbox.confirm("Anda yakin ingin menghapus syarat dari jalur masuk ?", function(result) {
            if(result==true){
                var id_jalur=$("#form_syarat_id_jalur").val();
          		
                var string = "id_jalur="+id_jalur+"&idSyarat="+idSyarat;
                $.ajax({
        			type	: 'POST',
        			url		: "<?php echo base_url(); ?>index.php/rf_pmb_jalur_penerimaan/hapusSyarat",
        			data	: string,
        			cache	: false,
        			success	: function(data){
