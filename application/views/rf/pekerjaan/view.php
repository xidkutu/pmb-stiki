                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
        				<table id="data<?php echo str_replace(' ','_',$page_title);?>" class="table table-striped table-bordered table-hover">
                           <thead>
                              <tr>
                                 <th class="sort-alpha">Id Pekerjaan</th>
                                 <th class="sort-alpha">Nama Pekerjaan</th>
                                 <th class="sort-alpha">Keterangan</th>
                           ...
                           <tfoot>
                                 <tr>
                                    ...
                                    <th>
                                       <input type="text" name="filter_nama" placeholder="Filter Pekerjaan" class="form-control input-sm datatable_input_col_search">
                                    </th>
                                    <th>
                                       <input type="text" name="filter_nama" placeholder="Filter Keterangan" class="form-control input-sm datatable_input_col_search">
                                    </th>
                                    <th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var table = $('#data<?php echo str_replace(' ','_',$page_title);?>').DataTable({
            "processing":true,
            "serverSide":true,
            "ajax":"<?php echo base_url()?>index.php/rf_pmb_pekerjaan/retrieveData"
        });
    ...
    function setHapusData(id,nama){
        bootbox.confirm("Anda yakin ingin menghapus pekerjaan "+nama+" ?", function(result) {
            if(result==true){
                var string="id="+id;
                $.ajax({
        			type	: 'POST',
        			url		: "<?php echo base_url(); ?>index.php/rf_pmb_pekerjaan/hapus",
        			data	: string,
        			cache	: false,
    ...
    function editData(id,nama,keterangan){
        $("#form_id_pekerjaan").val(id);
        $("#form_nama_pekerjaan").val(nama);
    ...
    function setChangeActive(id){
        ...
        $.ajax({
			type	: 'POST',
			url		: "<?php echo base_url(); ?>index.php/rf_pmb_pekerjaan/changeAktif",
			data	: string,
			cache	: false,
			success	: function(data){
