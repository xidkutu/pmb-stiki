...
<div class="row">
    <div class="note note-info" style="margin: 0 15px 10px 15px;">
    	<p>Silahkan membuka halaman <a href="http://forlap.dikti.go.id" target="_blank">forlap.dikti.go.id</a> untuk mendapatkan data Perguruan Tinggi beserta Prodinya masing-masing.</p>
    </div>
</div>
<div class="row">
	<div class="col-md-12">
			...
			<div class="portlet-body">
				<div class="table-container">
					...
					<tr role="row" class="heading">
						<th style="max-width:80px;">Kode PT</th>
                        <th>Nama PT</th>
                        <th>Kota</th>
                        <th style="max-width:90px;">Telephone</th>
                        <th>Email</th>
                        <th>Website</th>
                        <th>Aksi</th>
					</tr>
