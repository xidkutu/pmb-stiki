...
function edit_<?php echo $page_id;?>(id,text){
	...
	$.ajax({
		...
		success	: function(data){
            ...
            getKotaByProvinsi("Prov_PT","Kota_Asal_PT",data.Kota_Asal_PT);
...
$("#Prov_PT").change(function(){
    getKotaByProvinsi("Prov_PT","Kota_Asal_PT","");
})
function getKotaByProvinsi(src,target,setVal){
    ...
    $.ajax({
		type	: 'POST',
		url		: "<?php echo base_url(); ?>index.php/<?php echo $page_id;?>/getKotaByProvinsi",
		data	: string,
		cache	: false,
        dataType: 'json',
		success	: function(data){
