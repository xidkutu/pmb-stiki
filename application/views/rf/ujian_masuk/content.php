			...
			<div class="portlet-body">
				<div class="table-container">
					...
					<tr role="row" class="heading">
                        <th style="max-width: 100px;">Kode Prodi</th>
                        <th>Nama Prodi</th>
                        <th style="max-width: 80px;">Jenjang</th>
                        <th>Mata Ujian</th>
                        <th>Aksi</th>
					</tr>
                    </thead>
...
<script type="text/javascript">
    ...
    function setMataUjian(id,text){
        var string="id="+id;
        $.ajax({
			type	: 'POST',
			url		: "<?php echo base_url(); ?>index.php/<?php echo $page_id;?>/setViewForMataUjian",
			data	: string,
            dataType : "json",
			cache	: false,
            success	: function(data){
                $("#form_ujian_kode_prodi").val(id);
			    $("#form_ujian_mata_ujian").html(data.optMataUjian);
                $("#det_ProgramStudi").html(text);
                //Table pada detail
