...
function <?php echo $page_id;?>_btnSaveClick(){
    if(validation('form_rf_berkas')){
        var string = generateDataString('form_rf_berkas');
...
function edit_<?php echo $page_id;?>(id_berkas,detail_berkas){
    setResetForm();
    reset_validation();
    $("#id_berkas").val(id_berkas);
    $("#detail_berkas").val(detail_berkas);
    $(".form_rf_berkas#saveas").val('ubah');
