                ...
                <div class="portlet box green-haze">
                    ...
                    <div class="portlet-body">
        				<table id="data<?php echo str_replace(' ','_',$page_title);?>" class="table table-striped table-bordered table-hover">
                           <thead>
                              <tr>
                                 <th class="sort-alpha">Id Provinsi</th>
                                 <th class="sort-alpha">Nama Provinsi</th>
                           ...
                           <tfoot>
                                 <tr>
                                    ...
                                    <th>
                                       <input type="text" name="filter_nama" placeholder="Filter Provinsi" class="form-control input-sm datatable_input_col_search">
                                    </th>
                                    <th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var table = $('#data<?php echo str_replace(' ','_',$page_title);?>').DataTable({
            "processing":true,
            "serverSide":true,
            "ajax":"<?php echo base_url()?>index.php/rf_pmb_provinsi/retrieveData"
        });
    ...
    function setHapusData(id,nama){
        bootbox.confirm("Anda yakin ingin menghapus provinsi "+nama+" ?", function(result) {
            if(result==true){
                ...
                $.ajax({
        			type	: 'POST',
        			url		: "<?php echo base_url(); ?>index.php/rf_pmb_provinsi/hapus",
        			data	: string,
        			cache	: false,
    ...
    function editData(id,nama){
        $("#form_id_provinsi").val(id);
        $("#form_nama_provinsi").val(nama);
    ...
    function setChangeActive(id){
        ...
        $.ajax({
			type	: 'POST',
			url		: "<?php echo base_url(); ?>index.php/rf_pmb_provinsi/changeAktif",
			data	: string,
			cache	: false,
			success	: function(data){
