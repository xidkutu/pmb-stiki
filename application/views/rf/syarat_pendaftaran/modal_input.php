...
function <?php echo $page_id;?>_btnSaveClick(){
    if(validation('form_rf_syarat_daftar')){
        var string = generateDataString('form_rf_syarat_daftar');
...
function edit_<?php echo $page_id;?>(Id_SyaratDaftar,Detail_SyaratDaftar){
    setResetForm();
    reset_validation();
    $("#Id_SyaratDaftar").val(Id_SyaratDaftar);
    $("#Detail_SyaratDaftar").val(Detail_SyaratDaftar);
    $(".form_rf_syarat_daftar#saveas").val('ubah');
