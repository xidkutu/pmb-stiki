		...
		<div class="portlet light" style="margin-right: 20px;">
			...
			<div class="portlet-body">
                <div class="note note-info">
					...
					<p>
				        Pembayaran uang pendaftaran mahasiswa baru STIKI untuk S1 &amp; D3 sebesar <strong>Rp.200.000,-</strong>. Pembayaran dapat dilakukan melalui bank dengan Account berikut ini : 
					</p>
                ...
                <div class="portlet light bg-inverse">
					...
					<div class="portlet-body">
                       ...
                       <div class="col-md-12" style="text-align: center;">
                           <a href="javacript;;" class="btn blue" onclick="simpan()">
